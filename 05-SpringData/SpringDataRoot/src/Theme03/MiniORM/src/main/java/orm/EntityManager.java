...
public class EntityManager<E> implements DBContext<E> {
    ...
    private E createEntity(Class<E> entityType, ResultSet resultSet) throws SQLException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        for (Field declaredField : declaredFields) {
            ...
            Column columnAannotation = declaredField.getAnnotation(Column.class);

            String fieldName = columnAannotation == null
                    ? declaredField.getName()
                    : columnAannotation.name();
    ...
    private E fillData(E entity, Field field, String value) throws SQLException, IllegalAccessException {
